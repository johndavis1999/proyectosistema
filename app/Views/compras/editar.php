...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
                <h1>Editar Documento #<?= $compra['num_fact'] ?></h1>
          </div>
          ...
          <div class="">
              <div class="card card-primary">
                  <div class="card-header">
                      <h3 class="card-title">Compra Proveedor N. <?= $compra['id'] ?> </h3>
                  </div>
                  <form action="<?= base_url('actualizarCompra') ?>" method="POST" enctype="multipart/form-data">
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input  class="form-control" type="text" id="num_fact" name="num_fact" value="<?= $compra['num_fact'] ?>" placeholder="xxx-xxx-xxxxxxxxx" oninput="formatearNumero(this)" autocomplete="off">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="autorizacion_fact" name="autorizacion_fact" value="<?= $compra['autorizacion_fact'] ?>" oninput="formatoAutorizacion(this)" autocomplete="off">
                                        </div>
                                        <div class="form-group">
                                            <label for="fecha_doc">Fecha emision</label>
                                            <input type="date" class="form-control" id="fecha_doc" value="<?= $compra['fecha_doc'] ?>" name="fecha_doc" onclick="mostrarCalendario()"/>
                                        </div>
                                    </div>
                                            ...
                                            <table class="table table-responsive-sm" id="facturaItems" style="width: 100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="hidden" value="<?= $id_producto ?>" name="id_producto[]" id="id_producto_'<?php echo $count; ?>'" />
                                                    </td>
                                                    <td><input type="text" value="<?= $cantidad_compra ?>" name="cantidad_compra[]" id="cantidad_compra_<?php echo $count; ?>" class="form-control cantidad_compra"></td>
                                                    <td><input type="text" value="<?= $precio_compra ?>" name="precio_compra[]" id="precio_compra_<?php echo $count; ?>" class="form-control precio_compra" ></td>
                                                    <td><input type="text" value="<?= $descuento_item ?>" name="descuento_item[]" id="descuento_item_<?php echo $count; ?>" class="form-control descuento_item"></td>
                                                    <td><input type="text" value="<?= $iva_producto ?>" name="iva_producto[]" id="iva_producto_<?php echo $count; ?>" class="form-control iva_producto" readonly></td>
                                                    <td><input type="text" value="<?= $monto_subtotal_item ?>" name="monto_subtotal_item[]" id="monto_subtotal_item_<?php echo $count; ?>" class="form-control monto_subtotal_item" readonly></td>
                                                    <td><input type="text" value="<?= $monto_total_item ?>" name="monto_total_item[]" id="monto_total_item_<?php echo $count; ?>" class="form-control monto_total_item" readonly></td>
                                                </tr>
                                                <?php } ?>
                                            </table>
                                        </div>
                            ...
                            <div class="row">  
                                <div class="col-8">           
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="descripcion" id="descripcion" rows="4" placeholder="Añadir detalle adicional del documento" oninput="limitarAlfanumericosEspacios(); limitarCaracteres()"><?= $compra['descripcion'] ?></textarea>
...
<script>
    ...
    var numFilas = $('#facturaItems tr').length;

    if (numFilas > 1 && numElementos > 0 && !idProducto) {
