      ...
      <div class="" style="justify-content: center; align-items: center;">
          <div class="">
              <div class="card card-primary">
                  ...
                  <form action="<?= base_url('actualizarCotizacion') ?>" method="POST">
                        <div class="card-body">
                                        ...
                                        <div class="table-wrapper">
                                            <table class="table table-responsive-sm" id="facturaItems" style="width: 100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" value="<?= $cantidad_venta ?>" name="cantidad_venta[]" id="cantidad_venta_<?php echo $count; ?>" class="form-control cantidad_venta" readonly></td>
                                                    <td><input type="text" value="<?= $precio_venta ?>" name="precio_venta[]" id="precio_venta_<?php echo $count; ?>" class="form-control precio_venta" readonly></td>
                            ...
                            <div class="row">   
                                <div class="col-8">           
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="descripcion" id="descripcion" rows="4" placeholder="Añadir detalle adicional del documento" oninput="limitarAlfanumericosEspacios(); limitarCaracteres()"><?= $cotizacion['descripcion'] ?></textarea>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control align-right" id="subtotal" value="<?= $cotizacion['subtotal_cotizacion'] ?>" name="subtotal_cotizacion" placeholder="Subtotal">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control align-right" id="val_descuento" value="<?= $cotizacion['val_descuento'] ?>" name="val_descuento" placeholder="Valor Descuento">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control align-right" id="iva" value="<?= $cotizacion['val_iva'] ?>" name="val_iva" placeholder="Valor IVA" >
                                        </div>
                                    </div>
                                    <div class="form-group">
